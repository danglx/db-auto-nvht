    ...
    function _executeLazy(instance, configuration, items, event)
    {
        ...
        function _initialize()
        {
            ...
            if( configuration("defaultImage") !== null || configuration("placeholder") !== null )
                for( var i = 0; i < items.length; i++ )
                {
					...
					else if(tag == "image" && configuration("defaultImage") && !element.attr("xlink:href")) {
						element.attr("xlink:href", configuration("defaultImage"));
					}
        ...
        function _handleItem(element, tag)
        {
            ...
            imageObj.one("load", function()
            {
				...
				else if(tag == "image") element.attr("xlink:href", imageObj.attr("src"));//xlink:href
